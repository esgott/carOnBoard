...
public class CommandQueue {
    ...
    public enum GuiCommand {
        SELECT_RIGHT, SELECT_LEFT, SELECT_UP, SELECT_DOWN, STEP_FORWARD, STEP_BACKWARD, SELECTION_ON, SELECTION_OFF, RECORDING_ON, RECORDING_OFF, CONSUME_MATCH, VOLUME_INC, VOLUME_DEC, VOLUME_ACTIVE, TTS_ON, TTS_OFF, TRACK_CHANGED, SELECT_NEXT_SCREEN, SELECT_PREVIOUS_SCREEN
    }
