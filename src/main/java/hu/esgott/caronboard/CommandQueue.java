...
public class CommandQueue {
    ...
    public enum GuiCommand {
        SELECT_NEXT_ELEMENT, SELECT_PREVIOUS_ELEMENT, STEP_FORWARD, STEP_BACKWARD, SELECTION_ON, SELECTION_OFF, RECORDING_ON, RECORDING_OFF, CONSUME_MATCH, VOLUME_INC, VOLUME_DEC, VOLUME_ACTIVE, TTS_ON, TTS_OFF
    }
